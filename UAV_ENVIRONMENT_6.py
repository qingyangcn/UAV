            ...
            if stop.get('type') == 'D':
                ...
                if oid is not None and oid not in committed_set:
                    if self.debug_state_warnings:
                        print(f"[Warning] Drone {drone_id} route contains D stop for order {oid} not in commit_orders")
